...
CREATE SCHEMA ocpizza_test;

CREATE SEQUENCE ocpizza_test.formule_id_seq;
...
CREATE SEQUENCE ocpizza_test.categorie_nom_seq;
...
CREATE SEQUENCE ocpizza_test.ingredient_id_seq;
...
CREATE SEQUENCE ocpizza_test.produit_reference_seq;
...
CREATE SEQUENCE ocpizza_test.adresse_adresseid_seq;
...
CREATE SEQUENCE ocpizza_test.restaurant_nom_seq;
...
CREATE SEQUENCE ocpizza_test.compte_id_seq;
...
CREATE SEQUENCE ocpizza_test.commande_numero_seq;
...
CREATE SEQUENCE ocpizza_test.lignecommande_id_seq;
...
CREATE SEQUENCE ocpizza_test.facture_numerofacture_seq;
